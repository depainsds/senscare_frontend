                ...
                <div className='container'>
                    <div className='signup_section'>
                        ...
                        <div className={'more_about ' + (stap == "stap1" ? "" : "none")}>
                            ...
                            <ul>
                                <li className={category == "parents" ? "active" : ""} onClick={e => setcategory("parents")}>
                                    <span>
                                        <img src={category == "parents" ? './images/sign_service_fill.png' : './images/sign_service.png'} />
                                        <h4>I need a service</h4>
                                    </span>
                                    <p>Start your free search for child services in selected areas</p>
                                </li>
                                <li className={category == "provider" ? "active" : ""} onClick={e => setcategory("provider")}>
                                    <span>
                                        <img src={category == "provider" ? './images/sign_search_fill.png' : './images/sign_search.png'} />
                                        <h4>I need a job</h4>
                                    </span>
                            ...
                            <button onClick={e => {
                                category != '' ? setstap("stap2") : toast.error('Please select your needs.')
                            }}>Next</button>
                        </div>
                        <div className={'describe more_about ' + (stap == "stap2" ? "" : "none")}>
                            ...
                            <button onClick={e => {
                                Object.keys(describe).length >= 2 ? setstap("stap3") : toast.error('Please select yourself.')
                            }}>Next</button>
                        </div>
                        ...
                        <div className={'signupdetail ' + (stap == "stap1" || stap == "stap2" || stap == "stap3" ? "" : "none")} >
                            {category == "provider" ?
                                <>
                                    ...
                                    <ul>
                                        <li><img src='./images/thanks_right.png' /> <span>Create your profile.</span></li>
                                        <li><img src='./images/thanks_right.png' /> <span>Browse and apply for child services jobs.</span></li>
                                        <li><img src='./images/thanks_right.png' /> <span>Connect with schools and families.</span></li>
                                    </ul>
                                </>
                                : ""
                            }
